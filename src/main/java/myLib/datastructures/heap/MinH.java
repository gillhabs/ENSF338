...
public class MinH{
    ...
    private void heapifyDown(int i) {
        if (i == 0) {   // value to remove is at top of heap
            while (((elements.get(i) > left(i)) && (left(i) < elements.size()))) {
                swap(i, left(i));
                i = left(i);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Test print(). Expected result: 2    10   5");
        m.print();
        ...
        System.out.println("Test constructor given an integer array as an argument. Expected result: 0 1 3 7 6");
        int[] arr = {3, 7, 0, 1, 6};
        MinH m2 = new MinH(arr);
        m2.print();
